...
call add(s:no_tags, 'f:render')
call add(s:no_tags, 'f:base')
call add(s:no_tags, 'f:count')
call add(s:no_tags, 'f:form.hidden')
call add(s:no_tags, 'f:form.textfield')
call add(s:no_tags, 'f:form.checkbox')
call add(s:no_tags, 'f:form.password')
call add(s:no_tags, 'f:form.radio')
call add(s:no_tags, 'f:form.select')
call add(s:no_tags, 'f:form.textarea')
call add(s:no_tags, 'f:form.submit')
call add(s:no_tags, 'f:form.upload')
call add(s:no_tags, 'f:image')
call add(s:no_tags, 'f:layout')
call add(s:no_tags, 'f:link.email')
call add(s:no_tags, 'f:uri.email')
call add(s:no_tags, 'f:uri.page')
call add(s:no_tags, 'f:renderFlashMessages')
call add(s:no_tags, 'f:flashMessages')
call add(s:no_tags, 'f:format')
call add(s:no_tags, 'f:cObject')
...
let s:omittable = [ 
  \  ['address', 'article', 'aside', 'blockquote', 'dir', 'xdiv', 'dl', 'fieldset', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hr', 'menu', 'nav', 'ol', 'p', 'pre', 'section', 'table', 'ul'],
  \  ['dt', 'dd'],
  \  ['li'],
  \  ['thead', 'tbody', 'tfoot'],
  \  ['th', 'td'],
